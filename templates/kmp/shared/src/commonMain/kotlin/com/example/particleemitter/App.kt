...
/**
 * The shared UI for every platform: the simplest possible use of the library — one
 * [CanvasParticleEmitter] centered on screen emitting a gentle upward burst. Tweak the
 * [CanvasEmitterConfig] to make it your own.
 */
@Composable
fun App() {
    MaterialTheme {
